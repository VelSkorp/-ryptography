namespace DataEncryptionStandard
{
	...
	{
		private static readonly int[,] InitialPermutationIP = new int[,]
		{
		...
		private static readonly int[,] FinalPermutationIP = new int[,]
		{
		...
		private static readonly int[,] P_BoxExpansion = new int[,]
		{
			{ 32, 1,  2,  3,  4,  5  },
			{ 4,  5,  6,  7,  8,  9  },
			{ 8,  9,  10, 11, 12, 13 },
		...
		private static readonly int[,] StraightP_Box = new int[,]
		{
		...
		private static readonly int[,] KeyPreparationTable = new int[,]
		{
			{ 57, 49, 41, 33, 25, 17, 9  },
			{ 1,  58, 50, 42, 34, 26, 18 },
			{ 10, 2,  59, 51, 43, 35, 27 },
		...
		private static readonly int[,] KeyCompletionTable = new int[,]
		{
		...
		private static readonly int[,] SBox3 = new int[,]
		{
			...
			{ 13, 7,  0,  9,  3,  4,  6,  10, 2,  8,  5,  14, 12, 11, 15, 1,  }, //1,6 = 6
